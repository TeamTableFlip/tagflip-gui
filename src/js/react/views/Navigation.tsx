            ...
            <Navbar id="topNav" bg="dark" variant="dark" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto" activeKey={this.state.activeLink} onSelect={k => this.setState({ activeLink: k })}>
                        <Nav.Link onSelect={() => this.props.history.push("/annotationprojects")} eventKey="0">Annotation Projects</Nav.Link>
                        <Nav.Link onSelect={() => this.props.history.push("/corpora")} eventKey="1">Corpora</Nav.Link>
                        <Nav.Link onSelect={() => this.props.history.push("/editor")} eventKey="2">Editor</Nav.Link>
                        <Nav.Link onSelect={() => this.props.history.push("/settings")} eventKey="3">Settings</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
                <Dropdown alignRight>
